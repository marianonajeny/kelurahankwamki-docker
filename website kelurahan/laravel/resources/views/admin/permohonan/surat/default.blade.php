...
<div class="nomor">
    <table>
        ...
        <tr><td>Perihal</td><td>: <strong>{{ $permohonan->layanan?->nama ?? 'Surat Keterangan' }}</strong></td></tr>
    </table>
...
<div class="isi">
    ...
    <p>Surat ini dibuat untuk keperluan: <strong>{{ $permohonan->keperluan }}</strong>.</p>
