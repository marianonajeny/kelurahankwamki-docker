...
<div class="nomor">
    <table>
        ...
        <tr><td>Perihal</td><td>: <strong>Surat Keterangan Usaha</strong></td></tr>
    </table>
...
<div class="isi">
    ...
    <table class="data-table">
        ...
        <tr><td>No. HP</td><td>: {{ $permohonan->no_hp }}</td></tr>
    </table>
    <p>Adalah benar memiliki usaha yang berlokasi di wilayah Kelurahan Kwamki.</p>
    <p>Surat keterangan usaha ini dibuat untuk keperluan: <strong>{{ $permohonan->keperluan }}</strong>.</p>
